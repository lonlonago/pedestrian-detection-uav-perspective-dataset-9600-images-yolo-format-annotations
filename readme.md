# Pedestrian Detection UAV Perspective Dataset 9600 Images YOLO-Format Annotations

# Body

Pedestrian Detection Drone Viewpoint Dataset, 9600 images in YOLO format with annotations suitable for pedestrian detection, object recognition, and algorithm training.
are available for purchase at a moment's notice without returns or exchanges.
For those in need, please contact me directly. Details can be discussed privately.
